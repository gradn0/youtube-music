...
export const VerticalEllipsis = ({handleClick}: {handleClick: () => void}) => {
  return (
    <svg id="verticalEllipsis" onClick={handleClick} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6 cursor-pointer z-10">
